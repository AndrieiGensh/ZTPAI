...
__decorate([
    typeorm_1.Column(),
    __metadata("design:type", Number)
], CommentEntity.prototype, "dislikes", void 0);
__decorate([
    typeorm_1.ManyToOne(() => users_entity_1.UserEntity, user => user.comments),
    __metadata("design:type", users_entity_1.UserEntity)
], CommentEntity.prototype, "user", void 0);
__decorate([
    typeorm_1.ManyToOne(() => post_entity_1.PostEntity, (post) => post.comments),
